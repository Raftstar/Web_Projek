  ...
  return (
    <Container>
      <Wrapper className="max-w-2xl">
        <h1 className="text-3xl font-bold mb-3">Temporary Topup payments</h1>
        <div className="text-gray-600 dark:text-gray-400 space-y-5">
          <p>
            Web Aplication Top up kami bersama nanda dan mickhel masih dalam tahap pengembangan.
            Untuk itu semua pembayaran masih dalam bentuk ilustrasi sehingga
            tidak dikenakan biaya apapun.
          </p>
          <p>
            The Nanda And Mickhel web application is still under development. For
